  ...
  useEffect(() => {
    ...
    getAllPrendas()
      ...
      .catch((error) => {
        ...
        // En caso de error, también marcar que la carga ha terminado
        setLoading(false);
      });
  }, []);
    ...
    <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
      ...
      {loading && (
        <div role="status">
          ...
          <span className="sr-only text-white">CARGANDO PRENDAS CON IDENTIDAD...</span>
        </div>
      )}

      {/* Renderizar las tarjetas de la tienda si no hay carga */}
